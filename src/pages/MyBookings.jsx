...
function BookingSkeleton() {
  return (
    <div className="bg-white rounded-3xl p-6 border animate-pulse">
      ...
      {/* FOOTER */}
      <div className="mt-4 h-3 w-36 bg-gray-200 rounded"></div>
    </div>
  );
}
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mb-10 max-w-md relative">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 rounded-full border border-[#E5E7EB] focus:border-[#00C389] outline-none text-sm"
            />
          </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <span
                      className={`px-4 py-1 rounded-full text-xs font-semibold w-fit ${status.className}`}
                    >
                      {status.label}
                    </span>
                  </div>
